...
translation_dict = {
    "מרגיש מצוין": "Feeling great",
    "איטיות": "Slowness",
    "איטי": "Slow",
    "לא מצליח להתאזן ולהתאמן": "Can't balance or exercise",
    "בוקר טוב": "Good morning",
    "תחושה כללית פחות טובה": "General feeling not so good",
    "טוב": "Good",
    "קשה מאד": "Very difficult",
    "פיתה טחינה מלפפון עגבנייה ושניצל קטן": "Pita with tahini, cucumber, tomato and small schnitzel",
    "קערת קורנפלקס עם חלב סויה וצימוקים": "Cereal bowl with soy milk and raisins",
    "פלפל ומלפפון": "Pepper and cucumber",
    "שקדים טבעיים": "Raw almonds",
...
st.set_page_config(page_title="Fast Parkinson's Analyzer", layout="wide")
st.title("Fast Parkinson's Analyzer")
